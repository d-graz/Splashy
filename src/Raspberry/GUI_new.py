...
class Ui_MainWindowSplashy(object):
    def setupUi(self, MainWindowSplashy, database_manager, nfc_reader):
        ...
        self.labelMonthlyGoal.setStyleSheet("background: transparent; color: white; font-size: 32px")
...
"}     ")
        ...
        self.label_4.setStyleSheet("background: transparent; color: white; font: bold; font-size: 32px")
