...
"}     ")
    ...
    # define constant variables value
        ...
        splashyMonthlyGoal = self.db.liters_montly_goal * self.db.water_plasic_ratio     #TODO check float                               
        litersOfTheWeek = self.db.getTotalQuantity() 
        plasticSaved = self.db.getPlasticSaved()
        bottleSaved = plasticSaved / 0.015                               #TODO check float
        ...
        #progress bar
        self.progressBar.setMaximum(splashyMonthlyGoal)  # Imposta il valore massimo a 40
        self.progressBar.setValue(litersOfTheWeek)    # Imposta il valore corrente (default è 0)

        #labels
        self.labelMonthlyGoal.setText(str(splashyMonthlyGoal) + " kg")                           
        self.labelPlasticSaved.setText(str(bottleSaved) + " BOTTLES SAVED !")
        ...
        self.label_literRanking1.setText(str(firstTotalLiters) + " L")          #TODO check float
